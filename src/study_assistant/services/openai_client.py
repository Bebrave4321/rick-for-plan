                ...
                input=[
                    {
                        ...
                        "content": (
                            ...
                            "Use conversation_summary, recent_dialogue, dialogue_transcript, last_user_turn, "
                            "last_assistant_turn, and active_prompt_kind to resolve follow-up phrasing and understand "
                            "the latest assistant prompt. "
